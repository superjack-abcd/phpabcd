    ...
    <body>
        ...
        <main role="main">
            <section class="jumbotron text-center">
                <div class="container">
                    <h1 class="jumbotron-heading">Album ratchaprapa dam</h1>
                    <h1 class="jumbotron-heading">I took many year ago and found so buityfull it has then i share here.</h1>
                    <p> <a href="#" class="btn btn-primary my-2">Main album</a> <a class="btn btn-secondary my-2" href="http://rpb.egat.com/">Link to Dam website</a><link/><link/>&nbsp;</p>
                </div>
            </section>
