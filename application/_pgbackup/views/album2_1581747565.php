        ...
        <main role="main">
            <section class="jumbotron text-center">
                <div class="container">
                    ...
                    <p> <a href="#" class="btn btn-primary my-2">Main call to action</a> <a href="<?php base_url("index.php/imageupload/upload");?>" class="btn btn-secondary my-2">Secondary action</a> </p>
                </div>
            </section>
            <div class="album py-5 bg-light">
                <div class="container">
                <div class="row">
                        <?php print_r($todo_list); foreach ($todo_list as $item):
