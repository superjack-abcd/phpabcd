...
<html lang="en">
    ...
    <body>
        <nav role="navigation" class="white">
            <div class="nav-wrapper container">
                ...
                <ul class="right hide-on-med-and-down">
                    <li>
                        <a href="#" class="deep-orange-text">Navbar Link</a>
                    </li>
                </ul>
        ...
        <div id="index-banner" class="parallax-container">
            ...
            <div class="parallax">
                <img src="http://pinegrow.com/placeholders/img11.jpg" width="200"/>
            </div>
        </div>
        <div class="container">
            <div class="section">
        ...
        <div class="parallax-container valign-wrapper">
            ...
            <div class="parallax">
                <img src="http://pinegrow.com/placeholders/img12.jpg" width="200"/>
            </div>
        </div>
        <div class="container">
            <div class="section">
        ...
        <div class="parallax-container valign-wrapper">
            ...
            <div class="parallax">
                Hello parallax.
                <img src="http://pinegrow.com/placeholders/img13.jpg" width="200"/>
            </div>
        </div>
