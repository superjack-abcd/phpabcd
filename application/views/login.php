<html>
    <head>
        ...
        var verifyCallback = function(response) {
            //alert(response);
           // window.location.replace = "https://www.ubtsichol.com/index.php/user/login";
           // $("button[name='g_list']").enabled
            document.getElementById("g_list").disabled = false;
        ...
        document.getElementById("g_list").disabled = true; 
      };
    </script>
        <link href="https://stackpath.bootstrapcdn.com/bootstrap/4.4.1/css/bootstrap.min.css" rel="stylesheet">
        <!-- Custom styles for this template -->
    ...
    <body class="text-center">
        <form class="form-signin" action="<?=base_url('index.php/user/login')?>" method="post" accept-charset="utf-8">
            ...
            <center>
                ...
                <button class="btn btn-lg btn-primary btn-block" type="submit" id="g_list" disabled>Sign in</button>
