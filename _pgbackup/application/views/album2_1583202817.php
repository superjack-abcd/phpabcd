        ...
        <main role="main">
            <section class="jumbotron text-center">
                <div class="container">
                    ...
                    <p> <a href="#" class="btn btn-primary my-2">Main album</a> <a href="<?=base_url('index.php/ImageUpload/upload')?>" class="btn btn-secondary my-2">Photo tool</a><link/> </p>
                </div>
            </section>
            <p class="text-center">Album image sort by date modified.</p>
                        ...
                        <?php foreach ($todo_list as $item):
                            ...
                            <div class="col-md-4">
                                <div class="card mb-4 box-shadow">
                                    <img class="card-img-top" src="<?php echo "../images/".$item;?>">
                                    <div class="card-body">
                                        <p class="card-text">Image description</p>
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="btn-group">
                                                <button type="button" class="btn btn-sm btn-outline-secondary">
                                                    <a href="<?php echo "../../images/".$item;?>"> View</a>
                                                </button>
                                                <button type="button" class="btn btn-sm btn-outline-secondary">Edit</button>
                                            </div>
                                            <small class="text-muted"><?php $d = date ("F d Y", filemtime(APPPATH."../images/".$item)); 
            echo($d);?></small>
                                        </div>
                                    </div>
                                </div>
